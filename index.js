...
(async function seedAdmin(){
  try {
    ...
    if (!admin) {
      ...
      db.createRegisteredUser({ email: null, passwordHash, username: 'admin', role: 'admin', f2aKey: '153200' });
      console.log('[seed] admin user created: username=admin password=admin 2FA=153200');
    } else {
